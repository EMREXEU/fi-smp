...
public class SignatureVerifier {
  ...
  public boolean verifySignatureWithDecodedData(String certificate, String encodedData,
  ...
  public boolean verifySignature(String certificate, String data) throws Exception {
    ...
    DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
    dbf.setNamespaceAware(true);
    InputStream is = new ByteArrayInputStream(GzipUtil.gzipDecompressBytes(
        DatatypeConverter.parseBase64Binary(data))); // StandardCharsets.ISO_8859_1
